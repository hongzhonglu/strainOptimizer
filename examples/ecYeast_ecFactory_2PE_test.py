...
ecfactory_candidates_l3=pd.read_csv('code_etfl/reference/ecFactory/results/2_phenylethanol_targets/candidates_L3.txt',sep='\t',index_col=0).index.tolist()
ecfactory_candidates_l1=pd.read_csv('code_etfl/reference/ecFactory/results/2_phenylethanol_targets/candidates_L1.txt',sep='\t',index_col=0).index.tolist()
