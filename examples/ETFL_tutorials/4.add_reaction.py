...
# date : 2023/2/8 
# author : wangh
# file : 7.add_reaction.py
# project : etfl
'''codes for add metabolic/transcription/translation reaction to the model'''
from etfl.io.json import load_json_model
solver = 'optlang-gurobi'

# ec_cobra.reactions.ATPM.lower_bound = 0
growth_reaction_id = 'r_4041'
yeast = load_json_model('yetfl/models/yeast8_cEFL_2584_enz_128_bins__20221228_090737.json', solver=solver)
