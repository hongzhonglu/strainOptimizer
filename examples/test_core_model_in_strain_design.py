...
# test the function
# first relax the above constraints
# fix growth at 50% of its max value
ecoli.reactions.get_by_id('Biomass_Ecoli_core').bounds = growth.objective_value*0.5, 3
ecoli.reactions.get_by_id('EX_succ_e').bounds = 0, 1000
ecoli = constrain_enzymes_based_abs_abundance(model=ecoli, select_enzyme = 'EZ_TPI', ub0=0.1)
sol = ecoli.optimize()
