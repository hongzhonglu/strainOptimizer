...
def etfl_EVA(model0,targetID,enzymeIDlist,c_source,c_uptake,fraction_of_optimum=0.99,obj_direction='max'):
...
def enzymeVA(model,targetID,enzymeIDlist,c_source,c_uptake,fraction_of_optimum=0.99,obj_direction='max',model_type='etfl'):
    ...
    if model_type=='etfl':
        eva_result= etfl_EVA(model0=model,targetID=targetID,enzymeIDlist=enzymeIDlist,c_source=c_source,c_uptake=c_uptake,fraction_of_optimum=fraction_of_optimum,obj_direction=obj_direction)
